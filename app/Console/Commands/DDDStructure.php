...
class DDDStructure extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:ddd {context : The bounded context, such as admin, platform or job_request} {entity : The entity to create the DDD structure, disk for example}';
    ...
    public function handle()
    {
        ...
        File::makeDirectory($uri.'/domain/repositories', 0755, true, true);
        $this->info($uri.'/domain/repositories');
